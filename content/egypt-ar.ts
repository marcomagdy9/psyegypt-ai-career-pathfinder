...
أنا مساعد ذكاء اصطناعي مدعوم من [مبادرة 'إشراك مستقبل علم النفس' (EPF) التابعة لجمعية علم النفس الأمريكية (APA)](https://www.apa.org/about/governance/president/engaging-psychologys-future)، مصمم لمساعدتك على استكشاف المسارات المهنية من مرحلة البكالوريوس إلى الدكتوراه في مصر.
...
كيف يمكنني مساعدتك اليوم؟`,
    ...
    mainMenu: {
      ...
      discoveryQuiz: "🧩 أداة استكشاف المسار",
...
مهمتنا هي تمكينك بالوضوح والثقة، وسد الفجوة بين معرفتك الأكاديمية وتطبيقها القوي في العالم الحقيقي. نحن هنا لمساعدتك على استكشاف مستقبلك ولتصبح جزءًا من الجيل القادم من قادة علم النفس.`,
    ...
    team: {
        ...
        jaye: {
            ...
            mission: "دحض الخرافة السائدة بأن درجة الدرااسات العليا هي السبيل الوحيد لمهنة ناجحة في علم النفس. الدكتورة فان كيرك شغوفة بتمكين الطلاب من إدراك القيمة الهائلة وقابلية التسويق لدرجة البكالوريوس، وتزويدهم بالمعرفة لدخول سوق العمل بثقة.",
        ...
        marco: {
            ...
            bio: "رحلة ماركو إلى علم النفس لم تكن خطية. بعد أن بدأ في مجال مختلف، قام بتحول مهني شجاع، مدفوعًا بشغف جديد لفهم العقل البشري. ومع ذلك، اكتشف بسرعة أن الطريق لعلماء النفس الطموحين في مصر كان مليئًا بالعقبات: نقص الإرشاد الواضح، ومحدودية التوجيه، وفجوة بين النظرية الأكاديمية والوظائف في العالم الحقيقي. هذا الصراع الشخصي لم يكن طريقًا مسدودًا؛ بل أصبح مهمته. أسس ساي إيجيبت لبناء المورد الذي كان يتمناه لنفسه.",
            mission: "بصفته سفيرًا لجمعية علم النفس الأمريكية بالحرم الجامعي، يكرس ماركو جهوده لسد الفجوة بين الموارد الدولية والطلاب المحليين. مهمته هي استخدام التكنولوجيا لجعل المعرفة المهنية في متناول الجميع، مما يجعل الطريق إلى علم النفس أكثر وضوحًا وسهولة وأقل رهبة للجيل القادم من القادة في مصر.",
    ...
    careerDiscoveryQuiz: {
        startMessage: "سيساعدك هذا النشاط البسيط على اكتشاف المسارات المهنية التي تتوافق مع اهتماماتك. **هذا ليس تقييمًا رسميًا،** بل أداة لاقتراح نقطة انطلاق لاستكشافك. لنبدأ بفهم أين أنت في رحلتك التعليمية. ما هو مستواك التعليمي الحالي أو الأعلى؟",
        educationLevels: {
        ...
        results: {
            header: "بناءً على إجاباتك، إليك أهم المجموعات المهنية التي تبدو متوافقة مع اهتماماتك. **هذه نقطة بداية للاستكشاف، وليست تحديدًا نهائيًا لمسارك المهني.** استخدم هذه النتائج لبدء اكتشاف المسارات التفصيلية المتاحة لك.",
